...
public class Notes
{
	...
	public final static String SERVERUSER_LOGIN_SESSION = "SERVERUSER_LOGIN_SESSION"; // 用户后存放session名

	public final static String ServerUserFlagActive = "0"; // 用户未删除
	public final static String ServerUserFlagDeleted = "1"; // 用户已删除

	public final static String ServerUserStatuEnable = "0"; // 用户启用
	public final static String ServerUserStatuDisable = "1"; // 用户禁用

	public final static String ServerPathStatuActive = "0"; // 路径评价未删除
	public final static String ServerPathStatuDeleted = "1"; // 路径评价已删除

	public final static String ServerEvaluationStatuActive = "0"; // 设施评价未删除
	public final static String ServerEvaluationStatuDeleted = "1"; // 设施评价已删除

	public final static String ServerInfoStatuActive = "0"; // 设施信息未删除
	public final static String ServerInfoStatuDeleted = "1"; // 设施信息已删除
